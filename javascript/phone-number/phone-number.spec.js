...
describe('PhoneNumber()', function() {
  ...
  it('has some other area code on an invalid number', function() {
    var phone = new PhoneNumber('25554567890');
    expect(phone.areaCode()).toEqual('000');
  });

  it('has some other area code on an 11 digit (valid) number', function() {
    var phone = new PhoneNumber('15554567890');
    expect(phone.areaCode()).toEqual('555');
  });
  ...
  it('formats some other number starting with a 1', function() {
    var phone = new PhoneNumber('15554567890');
    expect(phone.toString()).toEqual('(555) 456-7890');
  });

  it('formats some invalid number', function() {
    var phone = new PhoneNumber('25554567890');
    expect(phone.toString()).toEqual('(000) 000-0000');
  });
});
