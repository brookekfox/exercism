...
describe('primeFactors', function() {
  ...
  it('factors 12312', function() {
    expect(primeFactors.for(12312)).toEqual([19, 2, 2, 2, 3, 3, 3, 3]);
  });

  it('factors 62500', function() {
    expect(primeFactors.for(62500)).toEqual([ 2, 2, 5, 5, 5, 5, 5, 5 ]);
  });
